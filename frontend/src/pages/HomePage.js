    ...
    <section className="mb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded shadow flex items-start">
          ...
          <div>
            <h3 className="text-xl font-semibold text-teal-600 mb-3">Effortless Equipment Assignment</h3>
        ...
        <div className="bg-white p-6 rounded shadow flex items-start">
          ...
          <div>
            <h3 className="text-xl font-semibold text-teal-600 mb-3">Instant Notifications</h3>
        ...
        <div className="bg-white p-6 rounded shadow flex items-start">
          ...
          <div>
            <h3 className="text-xl font-semibold text-teal-600 mb-3">Assignment History</h3>
